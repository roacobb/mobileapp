...
//check if currently on wp2android plugin page
function ml_using_wp2android() {
    return isset($_GET['page']) && strpos($_GET['page'], 'wp2android') !== false;
}

function ml_init_perfect_audience() {
    if(is_admin() && current_user_can('administrator') && ml_using_wp2android()) {
        ?>
...
olark('api.chat.sendNotificationToOperator', {
    body: 'Customer Information... User site: ' + "<?php echo esc_js($user_site); ?>" + ' Install URL: ' + "<?php echo get_site_url(); ?>" + ' Version: ' + "<?php echo wp2android_PLUGIN_VERSION;?>" + ' Post Count: ' + "<?php echo wp_count_posts()->publish; ?>" + ' Homepage Type: ' + "<?php echo get_option( 'show_on_front '); ?>"});
});
        ...
        ?>
            ...
            <script id="IntercomSettingsScriptTag">
              window.intercomSettings = {
                ...
                version: "<?php echo wp2android_PLUGIN_VERSION;?>",
