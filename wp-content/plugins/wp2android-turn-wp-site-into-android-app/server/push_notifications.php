<div id="ml_push_notifications" class="tabs-panel ml-compact">
    <?php if(strlen(wp2android::get_option('ml_pb_app_id')) <= 0 && strlen(wp2android::get_option('ml_pb_secret_key')) <= 0): ?>
    ...
    <?php else: ?>
    <form method="post" action="<?php echo admin_url('admin.php?page=wp2android_push&tab=notifications'); ?>">
