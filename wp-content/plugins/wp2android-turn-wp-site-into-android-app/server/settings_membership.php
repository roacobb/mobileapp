<div id="ml_settings_membership" class="tabs-panel ml-compact">
    <form method="post" action="<?php echo admin_url('admin.php?page=wp2android_settings&tab=membership'); ?>">
        ...
        <div class='ml-col-twothirds'>
            ...
            <div class="ml-form-row ml-checkbox-wrap">
                <input type="checkbox" id="ml_subscriptions_enable" name="ml_subscriptions_enable" value="true" <?php echo wp2android::get_option('ml_subscriptions_enable') ? 'checked' : ''; ?>/>
