<div id="ml_settings_analytics" class="tabs-panel ml-compact">
    <form method="post" action="<?php echo admin_url('admin.php?page=wp2android_settings&tab=analytics'); ?>">
        ...
        <h3>Google Analytics</h3>
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            <input size="36" type="text" id="ml_google_tracking_id" name="ml_google_tracking_id" placeholder="UA-XXXXXXXX-X" value='<?php echo wp2android::get_option('ml_google_tracking_id'); ?>'>
                        </td>
                    </tr>
                </tbody>
            </table>
	        ...
	        <div class='update-nag'>
				...
				<p> Your app was built wih a pre-configured Analytics ID, get in touch at <a href='mailto:support@wp2android.wps.edu.vn'>support@wp2android.wps.edu.vn</a> to know more.</p>
	        </div>
	        <?php endif; ?>
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    <input size="36" type="text" id="ml_fb_app_id" name="ml_fb_app_id" placeholder="XXXXXXXXXXXXXXX" value='<?php echo wp2android::get_option('ml_fb_app_id'); ?>'>
                </td>
            </tr>
            </tbody>
        </table>
        ...
        contact <a href="mailto:support@wp2android.wps.edu.vn">support@wp2android.wps.edu.vn</a>.
