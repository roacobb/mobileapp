...
class Class_leaflet_options {
	...
	public function display_page() {
		...
		echo '<h1 style="margin:0.83em 0 0.83em 0;float:left;">'.__('Settings','lmm').'</h1><div class="wrap lmmsettings" style="clear:both;">';
	...
	public function get_settings() {
		...
		$pro_option = '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-pro-option.png" width="65" height="15" alt="pro option" />';
		$pro_option_inline = ' <img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-pro-option.png" width="65" height="15" alt="pro option" style="display:inline;" />';
		...
		*/
		...
		$this->_settings['defaults_marker_popups_add_markername'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section6',
			'title'   => __('add markername to popup','lmm') . $pro_option,
		...
		$this->_settings['defaults_marker_popups_center_map'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section6',
			'title'   => __('center map on popup','lmm') . $pro_option,
		...
		*/
		$this->_settings['defaults_marker_shortcode_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __( 'You can also add markers directly to posts or pages without having to save them to your database previously. You just have to use the shortcode with the attributes lat and lon (e.g. <strong>[mapsmarker lat="48.216038" lon="16.378984"]</strong>).', 'lmm') . '<br/><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-marker-direct.jpg" width="408" height="80" /><br/><br/>' . __('Defaults values for markers added directly:','lmm'),
			'type'    => 'helptext'
		);
		...
		*/
		...
		$this->_settings['defaults_layer_mlm_filter_controlbox'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section8',
			'title'   => __('Controlbox for multi-layer-map filter','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => '1',
			'choices' => array(
		...
		*/
		...
		$this->_settings['defaults_layer_listmarkers_show_distance'] = array(
			...
			'section' => 'mapdefaults-section9',
			'title'   => '',
			'desc'    => __('Distance','lmm')  . $pro_option_inline . '<br/><span class="description">' . __('The actual distance value is only shown if sort by "distance from layer center" or "distance from current position" is selected','lmm') . '</span>',
			'type'    => 'checkbox',
			'std'     => 1
		);
		$this->_settings['defaults_layer_listmarkers_show_distance_unit'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __('Distance unit in list','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'km',
			'choices' => array(
		...
		$this->_settings['defaults_layer_listmarkers_show_distance_precision'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __( 'Distance precision', 'lmm' ) . $pro_option,
		...
		$this->_settings['defaults_layer_listmarkers_order_by'] = array(
			...
			'desc'    => __('can be changed by users dynamically when viewing the map on frontend','lmm'),
			'type'    => 'radio',
			'std'     => 'm.createdon',
			'choices' => array(
				...
				'distance_layer_center' => __('distance from layer center','lmm') . $pro_option_inline,
				'distance_current_position' => __('distance from current position','lmm') . $pro_option_inline
			)
		);
		...
		$this->_settings['defaults_layer_listmarkers_limit'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __( 'Default number of markers for paging', 'lmm' ),
			'desc'    => __( 'can be changed by users dynamically when viewing the map on frontend', 'lmm' ),
			'std'     => '10',
			'type'    => 'text'
		);
		...
		$this->_settings['defaults_layer_listmarkers_link_action'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __('Default action for clicking on icons or marker names','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'setview-open',
			'choices' => array(
		...
		$this->_settings['defaults_layer_listmarkers_link_action_zoom'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __('Zoom level to use for centering marker','lmm') . $pro_option,
		...
		$this->_settings['defaults_layer_listmarkers_action_bar'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __('Action bar visibility','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'show-full',
			'choices' => array(
		...
		$this->_settings['defaults_layer_listmarkers_searchtext'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __( 'Custom text for search field', 'lmm' ) . $pro_option,
		...
		$this->_settings['defaults_layer_listmarkers_searchtext_hover'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __( 'Custom hover text for search field', 'lmm' ) . $pro_option,
		...
		$this->_settings['defaults_layer_listmarkers_sort_id'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section9',
			'title'   => __('Available sort orders in action bar dropdown field','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['misc_map_dragging'] = array(
			...
			'choices' => array(
				'true' => __('true','lmm'),
				'false' => __('false','lmm'),
				'false-touch' => __('false for touch devices only','lmm')
			)
		);
		...
		$this->_settings['misc_map_scrollwheelzoom'] = array(
			...
			'choices' => array(
				'true' => __('true','lmm'),
				'true-fullscreen-only' => __('true (for fullscreen maps only)','lmm'),
				'false' => __('false','lmm')
			)
		);
		...
		$this->_settings['leaflet_hash_status'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section10',
			'title'   => __('URL hashes','lmm') . $pro_option,
		...
		$this->_settings['map_interaction_options_bounceatzoomlimits'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section10',
			'title'   => 'bounceAtZoomLimits' . $pro_option,
		...
		*/
		...
		$this->_settings['map_home_button'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section13',
			'title'   => __('Home button','lmm') . $pro_option,
		...
		$this->_settings['map_home_button_position'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section13',
			'title'   => __('Home button position','lmm') . $pro_option,
		...
		*/
		$this->_settings['minimap_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __( 'Add an expandable minimap to your maps which shows the same as the main map with a set zoom offset', 'lmm') . '<br/><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-minimap.jpg" width="400" height="183" />',
			'type'    => 'helptext'
		);
		...
		$this->_settings['minimap_collapsedWidth'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => 'collapsedWidth' . $pro_option,
		...
		$this->_settings['minimap_collapsedHeight'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => 'collapsedHeight' . $pro_option,
		...
		*/
		$this->_settings['clustering_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __( 'Clustering can be enabled/disabled for each layer separately on the layer edit page. Below you will find the global settings which are valid for all layer maps with clustering enabled.', 'lmm') . '<br/><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-clustering.jpg" width="500" height="204" />',
			'type'    => 'helptext'
		);
		...
		$this->_settings['clustering_helptext4'] = array(
			...
			'section' => 'mapdefaults-section18',
			'std'     => '',
			'title'   =>'spiderLegPolylineOptions' . $pro_option,
		...
		*/
		$this->_settings['gpx_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => '<img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-gpx.jpg" width="449" height="263" /><br/><br/>' . __( 'Settings below will be applied to all GPX tracks added to marker or layer maps.', 'lmm'),
			'type'    => 'helptext'
		);
		...
		*/
		$this->_settings['geolocate_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __('Add a geolocate button to all maps which allows to show and follow your current location:','lmm') . '<br/><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-geolocation.jpg" width="399" height="186" />',
			'type'    => 'helptext'
		);
		$this->_settings['geolocate_status'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => __('Add a geolocate button to each map','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'true',
			'choices' => array(
		...
		$this->_settings['geolocate_autostart'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => __('Autostart','lmm') . $pro_option,
		...
		$this->_settings['geolocate_position'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => __('Geolocate button position','lmm') . $pro_option,
		...
		$this->_settings['geolocate_keepCurrentZoomLevel'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => 'keepCurrentZoomLevel' . $pro_option,
		...
		$this->_settings['geolocate_units'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => __('Distance units','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'true',
			'choices' => array(
		...
		$this->_settings['geolocate_circlePadding'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => 'circlePadding' . $pro_option,
		...
		$this->_settings['geolocate_followCircleStyle'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => 'followCircleStyle' . $pro_option,
		...
		$this->_settings['geolocate_followMarkerStyle'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => 'followMarkerStyle' . $pro_option,
		...
		$this->_settings['geolocate_locateOptions'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section20',
			'title'   => 'locateOptions' . $pro_option,
		...
		*/
		$this->_settings['mlm_filter_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => '<br/><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-mlm-filter.jpg" width="400" height="222" />',
			'type'    => 'helptext'
		);
		$this->_settings['mlm_filter_controlbox_position'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section21',
			'title'   => __('Filter controlbox position','lmm') . $pro_option,
		...
		$this->_settings['mlm_filter_controlbox_name'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section21',
			'title'    => __('Attributes to display for each layer in controlbox','lmm') . $pro_option,
		...
		$this->_settings['mlm_filter_active_orderby'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section21',
			'title'   => __('Order active layers in controlbox by','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'markercount',
			'choices' => array(
		...
		$this->_settings['mlm_filter_active_sort_order'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section21',
			'title'   => __('Sort order for active layers in controlbox','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'DESC',
			'choices' => array(
		...
		$this->_settings['mlm_filter_inactive_orderby'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section21',
			'title'   => __('Order inactive layers in controlbox by','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'markercount',
			'choices' => array(
		...
		$this->_settings['mlm_filter_inactive_sort_order'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section21',
			'title'   => __('Sort order for inactive layers in controlbox','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'DESC',
			'choices' => array(
		...
		*/
		...
		$this->_settings['mapbox_access_token'] = array(
			...
			'pane'    => 'basemaps',
			'section' => 'basemaps-section1',
			'title'   => __('API access token','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['overlays_custom_tileurl'] = array(
			...
			'section' => 'overlays-section2',
			'title'   => __( 'Tiles URL', 'lmm' ),
			'desc'    => __('For example','lmm'). ": https://{s}.wien.gv.at/wmts/beschriftung/normal/google3857/{z}/{y}/{x}.png",
		...
		*/
		...
		$this->_settings['wms_wms_attribution'] = array(
			...
			'desc'    => '',
			'type'    => 'text',
			'std'     => 'WMS: City of Vienna (<a href=&quot;https://open.wien.at&quot; target=&quot;_blank&quot;>open.wien.at</a>)'
		);
		...
		*/
		...
		$this->_settings['google_maps_api_deferred_loading'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section1',
			'title'   => __('Deferred loading','lmm') . $pro_option,
		...
		$this->_settings['google_maps_api_status'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section1',
			'title'   => __('Google Maps API status','lmm') . $pro_option,
		...
		$this->_settings['google_places_status'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section1',
			'title'   => __('Google Places status','lmm') . $pro_option,
	...
	$this->_settings['misc_projections'] = array(
		...
		$this->_settings['misc_javascript_header_footer_pro'] = array( //info: 'misc_javascript_header_footer' removed with pro v1.5.5
			'version' => 'p1.5.6',
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __('Where to insert Javascript files on frontend?','lmm'),
			'desc'    => __('Footer is recommended for better performance. Only set to header if there is a theme or plugin conflict resulting in maps not being displayed.','lmm') . ' ' . __('If you choose footer, javascripts will also only be loaded when a shortcode is used and not on all pages.','lmm') . ' ' . __('Setting this option to header+inline-javascript is required, if maps should be displayed withing a jQuery mobile framework.','lmm'),
			'type'    => 'radio',
			'std'     => 'footer',
			'choices' => array(
		...
		$this->_settings['async_geojson_loading'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __('Async GeoJSON loading for layer maps','lmm') . $pro_option,
		...
		$this->_settings['misc_tab_hidden_div_compatibility'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __('Tab/hidden div compatibility','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['misc_marker_listing_columns_used_in_content'] = array(
			...
			'section' => 'misc-section4',
			'title'    => '',
			'desc'    => __('Used in content','lmm') . $pro_option_inline,
			'type'    => 'checkbox',
			'std'     => 1
		);
		...
		*/
		...
		$this->_settings['qrcode_visualead_helptext'] = array(
			...
			'section' => 'misc-section8',
			'std'     => '',
			'title'   => '<h3 class="h3-lmm-settings">' . __('Visualead settings','lmm') . '</h3><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-qr-visualead-preview.png" width="200" height="200" />',
			'desc'    => '',
			'type'    => 'helptext'
		);
		$this->_settings['qrcode_visualead_caching'] = array(
			...
			'desc'    => __('Save generated QR codes in the following directory for higher performance and for saving API calls:','lmm') . '<br/>' . LEAFLET_PLUGIN_QR_DIR . '<br/>' . __('Cached QR images will automatically be deleted if the according marker or layer map gets deleted!','lmm') . '<br/>' . sprintf(__('If you want to clear the full QR code images cache at once, please use the <a href="%1$s">according tool on the tools page</a>.','lmm'), LEAFLET_WP_ADMIN_URL . 'admin.php?page=leafletmapsmarker_tools#delete-qr-cache'),
			'type'    => 'radio',
			'std'     => 'enabled',
			'choices' => array(
				'enabled' => __('enabled','lmm'),
		...
		*/
		...
		$this->_settings['api_helptext3'] = array(
			...
			'desc'    =>  __('Please use the following options to further harden your API if needed:','lmm'),
			'type'    => 'helptext'
		);
		...
		$this->_settings['api_permissions_search'] = array(
			...
			'section' => 'misc-section9',
			'title'   => '',
			'desc'    => __('search existing markers/layers','lmm') . ' <img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-pro-feature.png" width="70" height="15" />',
			'type'    => 'checkbox',
			'std'     => 1
		);
		...
		*/
		...
		$this->_settings['capabilities_view_others'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section10',
			'title'   => __( 'User role needed for viewing markers/layers from other users', 'lmm' ) . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'edit_posts',
			'choices' => array(
		...
		*/
		...
		$this->_settings['xml_sitemaps_status'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Automatic Google XML sitemap integration','lmm'),
		...
		$this->_settings['xml_sitemaps_include'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Content to add to XML sitemap','lmm'),
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'both',
			'choices' => array(
		...
		$this->_settings['xml_sitemaps_exclude_markers'] = array(
			'version' => 'p2.6',
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Exclude specific markers','lmm'),
			'desc'    => sprintf(__('please enter a comma-separted list of IDs, like %1$s','lmm'), '<strong>1,2,3</strong>'),
			'std'   => '',
			'type'    => 'text'
		);
		$this->_settings['xml_sitemaps_exclude_layers'] = array(
			'version' => 'p2.6',
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Exclude specific layers','lmm'),
			'desc'    => sprintf(__('please enter a comma-separted list of IDs, like %1$s','lmm'), '<strong>1,2,3</strong>'),
			'std'   => '',
			'type'    => 'text'
		);
		$this->_settings['xml_sitemaps_priority_markers'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Priority for marker maps','lmm'),
		...
		$this->_settings['xml_sitemaps_priority_layers'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Priority for layer maps','lmm'),
			'desc'    => __('The priority of maps relative to other URLs on your site','lmm'),
			'type'    => 'select',
			'std'     => '0.5',
			'choices' => array(
		...
		$this->_settings['xml_sitemaps_change_frequency_markers'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Change frequency for marker maps','lmm'),
		...
		$this->_settings['xml_sitemaps_change_frequency_layers'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section11',
			'title'   => __('Change frequency for layer maps','lmm'),
			'desc'    => sprintf(__('How frequently the maps are likely to change. This value provides general information to search engines and may not correlate exactly to how often they crawl the page. Additional information available at %1$s','lmm'), '<a href="http://www.sitemaps.org/protocol.html" target="_blank">sitemaps.org</a>'),
			'type'    => 'select',
			'std'     => 'monthly',
			'choices' => array(
	...
	*/
	...
	public function save_defaults_for_new_options() {
		...
		if (version_compare(get_option('leafletmapsmarker_version'),'3.8.5','='))
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.8.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (version_compare(get_option('leafletmapsmarker_version'),'3.8.6','='))
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.8.7')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (version_compare(get_option('leafletmapsmarker_version'),'3.10','='))
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.10.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (version_compare(get_option('leafletmapsmarker_version'),'3.10.5','='))
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.10.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (version_compare(get_option('leafletmapsmarker_version'),'3.10.6','='))
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.11')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		*/
		...
		//info:  set defaults for options introduced in pro version 1.2
		...
		//info:  set defaults for options introduced in pro version 1.5.6
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'1.5.5','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.5.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.5.7
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'1.5.6','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.5.7')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.5.8
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'1.5.7','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.5.8')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.8
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'1.7','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.8')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.9
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'1.8.1','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.9')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.1
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.0','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.3
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.2','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.3')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.4
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.3.1','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.4')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.5
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.4','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.5')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.6
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.5','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.6.2
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.6.1','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.6.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.7
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.6.2','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.7')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 2.8
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.7.1','='))
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.7.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.7.3','='))
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p2.8')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
