...
if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.7.2','=')) {
	...
	set_transient( 'leafletmapsmarker_install_update_cache_vp273', 'execute install and update-routine only once a day', 60*60*24 );
}
/* template for pro plugin updates
if (version_compare(get_option('leafletmapsmarker_version_pro'),'2.xbefore','=')) {
