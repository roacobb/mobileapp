...
add_action( 'widgets_init', 'liveblog_random_posts_widget' );  

// Register Widget
function liveblog_random_posts_widget() {
    register_widget( 'liveblog_random_widget' );
}

// Widget Class
class liveblog_random_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        __('(ThemesPie) Random Posts', 'liveblog'), 

        // Widget description
        array( 'description' => __('A widget that displays the random posts of your blog', 'liveblog'), ) 
        );
    }
	...
	public function widget( $args, $instance ) {
		...
		$title = isset( $instance['title'] ) ? apply_filters('widget_title', $instance['title'] ) : __('Random Posts', 'liveblog');
	...
	public function form( $instance ) {
		...
		$defaults = array(
			'title' => __('Random Posts', 'liveblog'),
			'posts' => 4,
			'show_thumb' => 1,
			'show_cat' => 0,
			'show_author' => 0,
