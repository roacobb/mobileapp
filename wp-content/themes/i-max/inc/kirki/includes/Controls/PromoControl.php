	...
	protected function render_content() { ?>
        ...
        <div class="promo-2">
        	<div class="promo-wrap">
            	<a href="<?php esc_attr_e( 'http://templatesnext.org/ispirit/landing/', 'i-max' ); ?>"><?php esc_attr_e( 'Go Premium', 'i-max' ); ?></a>
                ...
                <a href="<?php esc_attr_e( 'https://wordpress.org/support/view/theme-reviews/i-max?filter=5#postform', 'i-max' ); ?>" target="_blank"><?php esc_attr_e( 'Rate i-max', 'i-max' ); ?></a>                                 
